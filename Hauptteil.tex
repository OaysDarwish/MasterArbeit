...
%
\subsection{Lauferkennung - Spitzendzähler} \label{abs:PeaksAufzaehlen} %TODO: was ist ein Schritt? 1 Hz ist ein Schritt oder 2 Schritte?
...
%\end{figure}
\begin{figure}[H] %TODO: als Figure darstellen
	\centering
...
Eine andere Methode hat sich ergeben, dass die Funktion 'Counter up' in dem Modell verwendet wird. Dieses Block zählt wie oft das Signals in die positive Richtung geht. Die neue Implementierung hat ein zuverlässiges Ergebnis im Vergleich zum vorherigen Modell geliefert. %TODO: mehr beschreiben und ein Beispielsignal darstellen.
...
\begin{figure}[H] % TODO: weglassen? Stop time beachten!
	\centering
...
\begin{figure}[H] %TODO: Als m-Figure darstellen mit Legende!
	\centering
...
\section{Anhalten} \label{sec:AmpelStehen} %TODO: Ausführlicher beschreiben. Mit Bilder
...
\end{figure}
%TODO: Sagen, warum diese Szenarien (3, 4, 5) getestet werden sollen!
...
\subsection{Referenz-Aktivitätsdaten (Ground truth)} %TODO: Die neuen Groundtruth sammeln und beschreiben.
