...
%
\subsection{1. Idee: Peaks aufzählen} \label{abs:PeaksAufzaehlen}
...
Da der Peakszähler nicht zuverlässig funktioniert hat, war eine bessere Idee notwendig. Das Modell muss die Frequenz des Signal ermitteln und diese denn auswerten.
Analog zum \autoref{abs:PeaksAufzaehlen} wurde hier eine neue Hypothese festgelegt, die durch einem Testmodell überprüft werden soll.

Die Hypothese: Die Frequenz während des Laufens sollte kleiner als $2 Hz$ sein und beim Fahren über $7 Hz$. Wenn eine Frequenz von über $7 Hz$ ermittelt wird, ist eine Laufaktivität ausgeschlossen, da ein Mensch auf keinen Fall 14 Schritte zurücklegen kann.

Dafür ist die FFT ein wichtiges Wort bei einer Frequenzermittlung.

Die App schreibt Messdaten mit der Frequenz von 100 Hz. D.h. pro Sekunde gibt es 100 Messwerte.
