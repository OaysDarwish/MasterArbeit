...
Das in der \autoref{fig:LaufenMuster} dargestellte Signal hat eine Frequenz von ca. $2$ Hz... (((((To be continued)))))
...
Annahme: Wenn das Handy in der Hosentasche ist und der Fahrer während einer Fahrt stark bremst und tut sein Fuß runter, dann gibt's eine Winkeländerung von 90 grad, was das Modell 'TipOver' aktiviert und zu einer Alarmauslösung führt.

Nach dem Testen: Keine falsche Alarmauslösungen. Grund ist, dass die Winkeländerung nicht 90 grad beträgt sondern nur ca. 20-30 grad. Die Person hat sein Bein beim Sitzen nicht genau horizontal sondern leicht nach Unten geneigt. Und wenn der Fahrer sein Fuß runter setzt, ist diese auch nicht genau vertikal sondern bisschen gebogen mit einem Winkel von ca. 10-20 Grad zum Vertikallinie. D.h. die Winkeländerung nicht 90 Grad ist.
