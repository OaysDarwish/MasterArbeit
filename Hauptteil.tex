...
\begin{itemize}
	\item[0] Für 'Stehen' bzw. 'keine Bewegung'
	\item[1] Für 'Laufen'
	\item[2] Für 'Fahren'
	\item[-1] Für 'Konflikt': Wenn die Entscheidungskriterien (Frequenz und Geschwindigkeit) verschiedene Aussagen liefern
\end{itemize}
...
Das in der \autoref{fig:LaufenMuster} dargestellte Signal hat eine Frequenz von ca. 
