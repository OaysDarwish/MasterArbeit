...
Wenn der Kraft $(F_q)$ größer als $(F_G)$ tritt, kippt das Motorrad um. D.h. $(F_G) > (F_q)$ ist im normalen Fall gültig.

Aus der \autoref{gl:Schraegwinkel} sollte $\lambda_{krit} = \arctan(1) = 45 \degree$

D.h. sollte das Motorrad über $45\degree$-Neigung hat, kippt um. 

Das Modell "TipOver" erkennt einen Unfall, wenn der Winkel über den Schwellwert ist.
