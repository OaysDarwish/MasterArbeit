...
\subsubsection{Kräfte am Fahrzeugschwerpunkt bei stationärer Kurvenfahrt}
...
Der Schrägwinkel der Einheit lässt sich wie folgt berechnet:
...
%\end{table}
P.S: EnergyThreshold ändert sich nach Geschwindigkeit und Rollwinkel (Ab 45 grad).\\

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Bilder/CH1_speed_CHEnergy.png}
	\caption{Fahrt Ohne CollisionHit}
