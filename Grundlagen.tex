...
In Android-Smartphones hat Google eine Reihe von APIs (Application Programming Interface) eingeführt, die es den Entwickler ermöglichen, Google-Dienste mit dem Android-Smartphones zu verbinden, um die Ergebnisse der Erkennung menschlicher Aktivitäten zu erhalten.
Diese API verwendet den eingebauten Android-Handysensor, um zwischen 8 Benutzeraktivitäten zu unterscheiden. Darunter werden “in vehicle”, “on bicycle”, “on foot”, “running”, “still” und “walking” erkannt. \citep{Tran2016}\citep{Elbayoumy2018}\\
...
\subsection{3. Feature: CollisionHit} %TODO: Abschnitt erweitern und ebenfalls umformulieren
%Beispiel...
%\begin{table}
%	\centering
