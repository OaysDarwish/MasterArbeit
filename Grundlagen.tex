...
\begin{figure}[H]
	...
	\begin{subfigure}{0.69\textwidth}
		\centering
		\includegraphics[height = 8cm]{Bilder/CH_speed_CHEnergy_FullView.png}
		\caption{FullView}
	...
	\begin{subfigure}{0.30\textwidth}
		\centering
		\includegraphics[height = 8cm]{Bilder/CH_speed_CHEnergy_zoomed.png}
		\caption{Zoomed}
...
\begin{figure}[H] %TODO: ein fall aus der atenbank vorstellen!
	\centering
	\includegraphics[width=\linewidth]{Bilder/CH1_speed_CHEnergy.png} % ID: 
