...
\begin{figure}[H] % TODO: Smartphone am Lnker haben!
	\centering
	\includegraphics[width=0.7\linewidth]{Bilder/AchsenSensor_Bike.png}  % TODO: Vektorgrafik
...
\begin{figure}[H] %TODO: Tabelle machen
	\centering
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.69\textwidth}
		\centering
		\includegraphics[height = 8cm]{Bilder/CH_speed_CHEnergy_FullView.png} % TODO: Vektorgrafik
		\caption{FullView}
		\label{fig:GH_Testfahrt_noGroundHit_EnergyFullView}
	\end{subfigure}
	%	\hfill
	\begin{subfigure}{0.30\textwidth}
		\centering
		\includegraphics[height = 8cm]{Bilder/CH_speed_CHEnergy_zoomed.png} % TODO: Vektorgrafik
		\caption{Zoomed}
		\label{fig:GH_Testfahrt_noGroundHit_EnergyZoomedVIew}
	\end{subfigure}
...
\begin{figure}[H]
	\centering % TODO: Subfigure einbauen
	\includegraphics[width=\linewidth]{Bilder/CH2_speed_CHEnergy.png} % TODO: Vektorgrafik
	\caption{Verlauf der Energie sowie des Energieschwellwerts bei einer echten Fahrt mit einer Kollision} % ID 2546
